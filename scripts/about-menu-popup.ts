...
const controlListItems: HTMLElement[] = document.querySelectorAll(
  '.popup-control-list-item'
);
const navigationListItems: HTMLElement[] = document.querySelectorAll(
  '.popup-navigation-list-item'
);
